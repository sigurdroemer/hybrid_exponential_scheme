...
% and show how to simulate using the hybrid-exponential scheme (by example on the rough Bergomi 
% model).
...
Xpaths = HybridExponentialScheme(N,n,T,x0,b,sigma,gamm,c,kappa,'K',K);
...
% Pricing:
tic;
[iv_1,se_1] = GetPricesRoughBergomi(s0,y,q,xi,eta,rho,H,strikes,ttm,'HybridExponential',N,n,...
